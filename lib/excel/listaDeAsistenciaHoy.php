...
// Incluimos el archivo de configuración
    ...
    $result = $preguntas->consultarRespuestasHoy();
    $x=0;
    while($row = $result->fetch_assoc()) {
        ...
        $output0 = '
                ...
                <th colspan="4">Tel 686-551-9060</th>
                <th>Fecha: '.$fechaHoy.'</th>
                </tr>
                <tr>
                </tr>
                </table> ';
      ...
      {  
           ...
           header("Content-Disposition: attachment; filename=Lista_de_Asistencia_$fechaHoy.xls");  
           echo $output0.$output;  
      }  
?>    