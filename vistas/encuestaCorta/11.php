...
<form id="eCorta1" method="post">
   <div class="divPreguntas">
      <div class="divInputs">
         <label for="como_de_saludForm"><strong>¿Cómo se siente de salud?</strong></label>
         <input type="text" id="como_de_saludForm" name="como_de_saludForm" value="<?=$como_de_salud?>" required autocomplete="off">
         
          <label for="servicio_moduloForm"><strong>Servicio que presto el modulo</strong></label>
          <input type="text" id="servicio_moduloForm" class="txt-center" name="servicio_moduloForm" value="<?=$servicio_modulo?>" required autocomplete="off">
      </div>
            <div>
          ...
          <input type="hidden" name="originarioMunicipioForm" id="originarioMunicipioForm" value="<?=$originarioMunicipio?>">
            ...
            <input type="hidden" name="nextPage" id="nextPage" value="FIN.php">
        </div>
    </div>
             <a href="10.php" class="txt-left flechasEAT"><span class="icon-arrow-left2"></span></a>
