...
<header>
   ...
   <div class="divPreguntas">
      <div class="divInputs enc-attencion">
          <label for="porque_mas_3_diasForm"><strong>¿Porqué lo detuvieron tantos dias?</strong></label>
          <input type="text" id="porque_mas_3_diasForm" class="txt-center" name="porque_mas_3_diasForm" value="<?=$porque_mas_3_dias?>" required autocomplete="off" autofocus>
      </div>
            <div>
