...
<h1>¿Que dia salio de su casa?</h1>
<form id="eCorta1" method="post">
   <div class="divPreguntas">
      <div class="divInputs">
        <label for="c_fecha_salio_casaForm">Año</label>
         <select name="c_fecha_salio_casaForm" id="c_fecha_salio_casaForm" class="inputEAT txt-center selectEAT"> <!-- Los años se cargan con javascript y jquery -->
         <?php
             if($c_fecha_salio_casa=="")
             {
                 
             }else{
              ?>
              <option value="<?=$c_fecha_salio_casa?>"><?=$c_fecha_salio_casa?></option>
             <?php
             }
             ?>
        </select>
 ...
 <script>
        $(document).ready(function(){
            ...
            {
                $("#c_fecha_salio_casaForm").append(new Option(i,i));
            }
        });
    </script>
<?php
